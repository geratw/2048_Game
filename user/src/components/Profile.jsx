...
const Profile: FC = () => {
  ...
  let board = [];
  let score = 0;
  const mergeAudio = new Audio("image/SoundStep.mp3");
  ...
  function toggleMute() {
    ...
    if (mergeAudio.muted === true) {
      ...
      soundImage.src = "image/sound-on.png";
    } else {
      mergeAudio.muted = true;
      soundImage.src = "image/sound-off.png";
    }
  }
  ...
  return (
    <div className="main-content">
      <nav className="navigation">
        <ul>
          <li>Результат последней игры</li>
          <li>2048</li>
          <li>10 лучших игр</li>
          <li onClick={() => store.logout()}>Выйти</li>
        </ul>
      </nav>
      <div className="intro">
        <h1 className="intro_title">2048</h1>
        {/* <button className="score btn-top" onclick="showTopScores()"><strong>Top Games</strong></></button> */}
        <div className="status-game">
          <p className="score score-left">
            <strong>Best Score:</strong> <span id="best-score">0</span>
          </p>
          <button
      ...
      <div id="info">
        <p>
          <strong>Controls:</strong> Use arrow keys to move tiles.
        </p>
        <div className="arrow-img">
          <img src="image/icon-up.png" alt="icon-up" />
          <img src="image/icon-right.png" alt="icon-right" />
          <img src="image/icon-left.png" alt="icon-left" />
          <img src="image/icon-down.png" alt="icon-down" />
        </div>
      </div>
      <button
        className="btn-sound"
        ...
        onClick={() => toggleMute()}
      >
        <img src="image/sound-on.png" alt="soundImage" id="soundImage" />
      </button>
    </div>
  );
};
